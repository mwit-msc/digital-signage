...
(function() {
    ...
    function getDynamicSuggestion(aqi, temperature) {
        ...
        if (aqi <= 50) {
            return 'อากาศดี เหมาะออกกำลังกายกลางแจ้ง';
        }
        if (aqi <= 100) {
            return 'ควรสวมหน้ากากอนามัยเมื่ออยู่นอกอาคาร';
        }
        if (aqi <= 150) {
            return 'กลุ่มเสี่ยงควรลดกิจกรรมกลางแจ้ง ควรสวมหน้ากากอนามัย';
        }
        if (aqi <= 200) {
    ...
    function getAQIInfo(aqi) {
        ...
        if (aqi <= 200) return {
            ...
            message: 'อาจได้รับผลกระทบต่อสุขภาพ ควรลดกิจกรรมกลางแจ้ง',
            emoji: '😷'
        };
        ...
        if (aqi <= 300) return {
            ...
            textColor: 'text-white',
            level: 'อันตราย',
            message: 'ควรหลีกเลี่ยงกิจกรรมกลางแจ้ง',
            emoji: '🤢'
        };
        ...
        return {
            ...
            textColor: 'text-white',
            level: 'อันตรายมาก',
            message: 'ควรงดกิจกรรมกลางแจ้งทั้งหมด',
            emoji: '☠️'
        };
    }
